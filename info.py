...
auth_channel = environ.get('AUTH_CHANNEL', '-1001849853265')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URI', "mongodb+srv://mbthanishk:mbthanishk@cluster0.6yrsmw3.mongodb.net/?retryWrites=true&w=majority")
